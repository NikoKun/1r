...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // inici
        boolean iniciusu = false;
        String contactes[][] = new String[7][20];
                    ...
                    for (int i = 0; i < 20; i++) {
                        if (reg.equals(usuaris[5][i])) {
                            if (pass.equals(usuaris[6][i])) {
                                System.out.println("-------------------------------------------------------------------");
                                System.out.println("Benvingut "+reg+"!!!");
                                while (iniciusu){
                                    System.out.println("-------------------------------------------------------------------");
                                    System.out.println("  - Wala escoge el sabor que prefieras:");
                                    System.out.println("-------------------------------------------------------------------");
                                    System.out.println("1. Afegir un contacte");
                                    System.out.println("2. Eliminar un contacte");
                                    System.out.println("3. Editar un contacte");
                                    System.out.println("4. Llistar els contactes");
                                    System.out.println("5. Exit");
                                    System.out.println("-------------------------------------------------------------------");
